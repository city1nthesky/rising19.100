...
#include "../../../../../UnixRav3/RavQt/Config/common/blacklistiptable.h"
...
struct qt_meta_stringdata_IpIconDelegate_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_IpIconDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_IpIconDelegate_t qt_meta_stringdata_IpIconDelegate = {
    {
QT_MOC_LITERAL(0, 0, 14) // "IpIconDelegate"
...
static const uint qt_meta_data_IpIconDelegate[] = {
...
void IpIconDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject IpIconDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_IpIconDelegate.data,
      qt_meta_data_IpIconDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *IpIconDelegate::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *IpIconDelegate::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_IpIconDelegate.stringdata0))
        return static_cast<void*>(const_cast< IpIconDelegate*>(this));
    return QItemDelegate::qt_metacast(_clname);
}

int IpIconDelegate::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
QT_MOC_LITERAL(1, 17, 12), // "AddIpNameEnd"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 11), // "ShowToolTip"
QT_MOC_LITERAL(4, 43, 3) // "row"

    },
    "BlacklistIPTable\0AddIpNameEnd\0\0"
    "ShowToolTip\0row"
};
#undef QT_MOC_LITERAL
