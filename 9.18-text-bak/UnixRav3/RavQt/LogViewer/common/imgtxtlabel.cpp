...
void ImgTxtLabel::enterEvent(QEvent *pEvent)
{
    Q_UNUSED(pEvent);
    m_bEntered = true;
    update();
...
void ImgTxtLabel::leaveEvent(QEvent *pEvent)
{
    Q_UNUSED(pEvent);
    m_bEntered = false;
    update();
...
void ImgTxtLabel::mouseMoveEvent(QMouseEvent *pEvent)
{
    Q_UNUSED(pEvent);
}
...
void ImgTxtLabel::mouseReleaseEvent(QMouseEvent *pEvent)
{
    Q_UNUSED(pEvent);
    if(m_bMousePressed)
    {
...
void ImgTxtLabel::paintEvent(QPaintEvent *pEvent)
{
    Q_UNUSED(pEvent);
