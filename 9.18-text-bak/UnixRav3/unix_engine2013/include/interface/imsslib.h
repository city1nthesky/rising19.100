...
class IMssLibFilePatcherEx : public IUnknown
{
public:
	STDMETHOD(GetTable)(MSTNAME name , IREStream** pstm)PURE;
	RE_DECLARE_IID;
};
// {04BFE02E-1586-4F7C-8B6C-AABB075B57AE}
RE_DEFINE_IID(IMssLibFilePatcherEx, "04BFE02E-1586-4F7C-8B6C-AABB075B57AE",
