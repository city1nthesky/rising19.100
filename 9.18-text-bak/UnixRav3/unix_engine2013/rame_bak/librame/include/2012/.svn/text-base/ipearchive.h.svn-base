...
public:
	...
	STDMETHOD_(DWORD, IsExistingExportApi )(DWORD dwApiNameCrc,DWORD dwModuleNameCrc = NULL) PURE;
	STDMETHOD_(DWORD, GetExportApiByOrdinal )(DWORD dwOrdinals) PURE;
	STDMETHOD(RavIsExportApi )(DWORD dwRAV,BOOL *pbIsExportApi,LPSTR strApiName = NULL,DWORD dwApiNameSize = NULL,LPSTR strModuleName = NULL,DWORD dwModuleNameSize = NULL) PURE;
...
struct FND
{
	...
	UINT64	RAW;
	SIZE_T	Len;						// 
	UINT64	Hash;						// 该函数的HASH值
	UINT64	Ref1;						// 记录第一个调用点
	SIZE_T	RefNum;						
	SIZE_T	Flags;
	SIZE_T	InsCount;
