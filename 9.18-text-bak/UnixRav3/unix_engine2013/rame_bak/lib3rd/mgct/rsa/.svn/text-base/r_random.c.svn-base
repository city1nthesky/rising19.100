...
UINT4 subrand PROTO_LIST((long));

/* Set up, random object ready for seeding. */

int R_RandomInit( R_RANDOM_STRUCT *random )/* new random structure */
{
...
UINT4 subrand(long idum) {

    UINT4 irword, lword;
    long idums = 0;
    UINT4 i, ia, ib, iswap, itmph=0, itmpl=0;

    UINT4 c1[NITER] = { 0xbaa96887L, 0x1e17d32cL, 0x03dcbc3cL, 0xf033d1b2L };
    UINT4 c2[NITER] = { 0x4bf03b58L, 0xe8740fc3L, 0x69aac5a6L, 0x55a7ca46L };
...
//	randomStruct.outputAvailable = 16;
//	randomStruct.state = 
//
