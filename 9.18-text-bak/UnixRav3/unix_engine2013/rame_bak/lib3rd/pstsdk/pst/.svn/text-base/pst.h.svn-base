...
#include "../ndb/database.h"
#include "../ndb/database_iface.h"
#include "../ndb/node.h"

#include "../ltp/propbag.h"
#include "../ltp/nameid.h"

#include "../pst/folder.h"
#include "../pst/message.h"
...
class pst : public RefalbeImp ,private boost::noncopyable
{
