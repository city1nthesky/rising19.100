...
RightTopWidget::RightTopWidget(QWidget *parent, int function, int nHeight) : QScrollArea(parent),m_pTopWidget(NULL)
{
    ...
    m_pTopWidget = new TopScrollWidget(this, m_pMainWindow, function);
