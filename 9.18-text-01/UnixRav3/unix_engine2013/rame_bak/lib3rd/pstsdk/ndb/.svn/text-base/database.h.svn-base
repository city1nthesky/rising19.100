...
protected:
	...
	friend shared_db_ptr open_database(IRXStream* pstm);
	friend std::tr1::shared_ptr<small_pst> open_small_pst(IRXStream* pstm);
	friend std::tr1::shared_ptr<large_pst> open_large_pst(IRXStream* pstm);
...
inline std::tr1::shared_ptr<pstsdk::small_pst> pstsdk::open_small_pst(IRXStream* pstm)
{
	std::tr1::shared_ptr<small_pst> db(new small_pst(pstm));
	return db;
}
...
/////////////////////////////////////////////////////////////////////////////////////
inline std::tr1::shared_ptr<pstsdk::large_pst> pstsdk::open_large_pst(IRXStream* pstm)
{
	std::tr1::shared_ptr<large_pst> db(new large_pst(pstm));
	return db;
}

inline pstsdk::shared_db_ptr pstsdk::open_database(IRXStream* pstm)
{
	try
	{
		shared_db_ptr db = open_small_pst(pstm);
		return db;
	}
	catch(invalid_format&)
	{
	...
	shared_db_ptr db = open_large_pst(pstm);
	return db;
}
...
//////////////////////////////////////////////////////////////////////
template<typename T>
inline pstsdk::database_impl<T>::database_impl(IRXStream* pstm)
{
	m_file = new RxFile(pstm);
