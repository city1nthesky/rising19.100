...
JMatchTable::JMatchTable (JHashPos const * const cpHsh,  JFileIn  * const apFilOrg, JFileIn  * const apFilNew, const bool abCmpAll)
 ...
 * ---------------------------------------------------------------------------*/
int JMatchTable::add (
  offset_t const &azFndOrgAdd,      /* match to add               */
  offset_t const &azFndNewAdd,
  offset_t const &azBseNew,
  int   const aiEqlNew
){
    offset_t lzDlt ;            /* delta key of match */
...
bool JMatchTable::get (
  offset_t const &azRedOrg,       // current read position on original file
  offset_t const &azRedNew,       // current read position on new file
  offset_t &azBstOrg,             // best position found on original file
  offset_t &azBstNew              // best position found on new file
) const{
    ...
    offset_t lzTstNew ;    // test/found position in new file
    offset_t lzTstOrg ;    // test/found position in old file
 ...
 * ---------------------------------------------------------------------------*/
bool JMatchTable::cleanup ( offset_t const &azBseNew ){
    rMch *lpCur ;
    rMch *lpPrv ;
...
int JMatchTable::check (
    offset_t &azPosOrg, offset_t &azPosNew,
    int aiLen, int aiSft
    ) const
{ int lcOrg=EOF ;
  int lcNew=EOF ;
