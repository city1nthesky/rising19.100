...
#if defined COMPATIBILITY_ARM_PLATFORM || defined COMPATIBILITY_FEDORA_ZHAOXIN_PLATFORM
	static HRESULT create_instance(IUnknown *prot, IUnknown *punkOuter, const IID& riid, void **ppv) RS_GCC_OPTIMIZE_O1;
#else
...
template<class CLS>
HRESULT TStdClsFactory<CLS>::create_instance(IUnknown *prot, IUnknown *punkOuter, const IID& riid, void **ppv)
{
	*ppv = 0;
