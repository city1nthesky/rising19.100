...
class IRXParametersAccess : public IUnknown
{
public:
	STDMETHOD(GetParamNames(xv::Value& val))PURE;
	STDMETHOD(CopyParamsTo(IRXParameters* param))PURE;
	RE_DECLARE_IID;
};
// {8CCC3B54-F3FB-4C6F-8F67-7A2FF6FBE3B7}
RE_DEFINE_IID(IRXParametersAccess, "{8CCC3B54-F3FB-4C6F-8F67-7A2FF6FBE3B7}" , 
			0x8ccc3b54, 0xf3fb, 0x4c6f, 0x8f, 0x67, 0x7a, 0x2f, 0xf6, 0xfb, 0xe3, 0xb7);



class IRXLicenseConfig : public IUnknown
{
public:
	RE_DECLARE_IID;
	STDMETHOD(GetEngineParam(IRXParameters* param))PURE;
	STDMETHOD(GetFormatList(IREFormatList* fmtlst))PURE;
};
// {9CE8992D-71C2-4D9D-B684-87AD5265189B}
RE_DEFINE_IID(IRXLicenseConfig,"{9CE8992D-71C2-4D9D-B684-87AD5265189B}", 
			0x9ce8992d, 0x71c2, 0x4d9d, 0xb6, 0x84, 0x87, 0xad, 0x52, 0x65, 0x18, 0x9b);
